...
class Course(models.Model):
    ...
    sub_category = models.ForeignKey("CourseSubCategory",on_delete=None) #

    course_type_choices = ((0, '付费'), (1, 'VIP专享'), (2, '学位课程'))
    course_type = models.SmallIntegerField(choices=course_type_choices)

    degree_course = models.ForeignKey("DegreeCourse", blank=True, null=True, help_text="若是学位课程，此处关联学位表",on_delete=None)
...
class CourseDetail(models.Model):
    """课程详情页内容"""
    course = models.OneToOneField("Course",on_delete=None,related_name='detail')
...
class CourseChapter(models.Model):
    """课程章节"""
    course = models.ForeignKey("Course", related_name='coursechapters',on_delete=None)  #related_name是用course对象反向查找本表的名字时用的
...
class CourseSubCategory(models.Model):
    ...
    category = models.ForeignKey("CourseCategory",on_delete=None)
    name = models.CharField(max_length=64, unique=True)
...
class Scholarship(models.Model):
    """学位课程奖学金"""
    degree_course = models.ForeignKey("DegreeCourse",on_delete=None)
...
class CourseOutline(models.Model):
    """课程大纲"""
    course_detail = models.ForeignKey("CourseDetail",on_delete=None)
...
class CourseSection(models.Model):
    """课时目录"""
    chapter = models.ForeignKey("CourseChapter", related_name='coursesections',on_delete=None)
    name = models.CharField(max_length=128)
...
class Homework(models.Model):
    chapter = models.ForeignKey("CourseChapter",on_delete=None)
...
#     """
#     enrolled_course = models.ForeignKey("EnrolledDegreeCourse",on_delete=None)
...
class Article(models.Model):
    ...
    source = models.ForeignKey("ArticleSource", verbose_name="来源",on_delete=None)
...
class Comment(models.Model):
    """通用的评论表"""
    content_type = models.ForeignKey(ContentType, blank=True, null=True, verbose_name="类型",on_delete=None)
    object_id = models.PositiveIntegerField(blank=True, null=True)
    content_object = GenericForeignKey('content_type', 'object_id')

    p_node = models.ForeignKey("self", blank=True, null=True, verbose_name="父级评论",on_delete=None)
...
class UserAuthToken(models.Model):
    ...
    用户Token表
    """
    user = models.OneToOneField(to="Account",on_delete=None)
